...
const SignIn = () => {
    ...
    return (
        <div className="w-full max-w-md p-4 mx-auto rounded-md shadow sm:p-8 mt-[100px] mb-[100px]">
	<h2 className="mb-3 text-3xl font-semibold text-center">Sign to your account</h2>
	<p className="text-sm text-center dark:text-gray-600">Dont have account?
		<NavLink to="/signup" className="focus:underline hover:underline">Sign up here</NavLink>
	</p>
